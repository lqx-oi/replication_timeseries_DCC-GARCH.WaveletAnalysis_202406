# A Study on the Effectiveness of Corn Futures as a Safe-Haven Asset During the Russia-Ukraine Conflict
## Based on DCC-GARCH and Wavelet Analysis
...
- **Programming languages:** Stata; R; MATLAB
